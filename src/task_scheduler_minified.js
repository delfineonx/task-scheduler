...
TS_.tick=()=>{let q=K[T+=I];I=0;if(q){let k=q[0],g=q[1],o=q[2],a,p;do{try{while(p=o[A]){a=g[A];if(S){L=P[a]>p;N=C[a]--}S=0;if(N<2){delete C[a];delete P[a]}if(!L){k[A]()}S=1;A++}delete K[T];A=0;break}catch(e){S=1;A++;api.broadcastMessage("Scheduler ["+a+"]: "+e.name+": "+e.message+".",{color:"#ff9d87"})}}while(!0)}I=1};
Object.freeze(TS_);
globalThis.TS=TS_;
void 0
}
