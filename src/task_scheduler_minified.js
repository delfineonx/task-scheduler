...
TS_.run=(k,d,g)=>{g??=U;d=(d|0)*.02|0;d=d&~(d>>31);let t=T+d,q=K[t],i=0;if(!q){q=K[t]=[[k],[g],[++O]];C[g]=(C[g]|0)+1}else{i=q[0].length;q[0][i]=k;q[1][i]=g;q[2][i]=++O;C[g]=(C[g]|0)+1}if(!d){k();q[0][i]=F}return()=>{if(K[t]){q[0][i]=F}}};
